...
/*   Updated: 2024/11/18 16:10:57 by gneto-co         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define FT1_ANNOUNCE(class_n, function_n) PRINT << BRIGHT_BLUE BOLT << class_n << ": " << function_n << RESET << ENDL;
#define FT2_ANNOUNCE(class_n, function_n) PRINT << BRIGHT_CYAN BOLT << class_n << ": " << function_n << RESET << ENDL;
